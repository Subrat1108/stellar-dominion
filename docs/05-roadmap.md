...
**Out of scope / deferred (as of the landing arc):** the strategic-resource network / trade routes / logistics / transport (the economy slice, `docs/16`); rival/AI owners; 3B depth; the hard-start retune; a real EDL descent/risk mechanic. *(The "no tile/surface-spatial layer" item that was here has since been reversed — see the surface-layer phase above + `docs/09` 2026-07-20.)*
